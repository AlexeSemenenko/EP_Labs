	...
	int nCmdShow)
{
	...
	CreateWindow("button", "C", WS_CHILD | WS_VISIBLE | BS_PUSHBUTTON, 400, 100, 55, 40, hwnd, (HMENU)15, hInstance, NULL);
	...
	CreateWindow("button", "(", WS_CHILD | WS_VISIBLE | BS_PUSHBUTTON, 270, 100, 55, 40, hwnd, (HMENU)18, hInstance, NULL);
	CreateWindow("button", ")", WS_CHILD | WS_VISIBLE | BS_PUSHBUTTON, 335, 100, 55, 40, hwnd, (HMENU)19, hInstance, NULL);
	CreateWindow("button", "^", WS_CHILD | WS_VISIBLE | BS_PUSHBUTTON, 140, 250, 55, 40, hwnd, (HMENU)20, hInstance, NULL);
	CreateWindow("button", "<=", WS_CHILD | WS_VISIBLE | BS_PUSHBUTTON, 465, 100, 55, 40, hwnd, (HMENU)21, hInstance, NULL);
