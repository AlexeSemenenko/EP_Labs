...
// vigenere_cipher.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CvigenerecipherApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CvigenerecipherApp

CvigenerecipherApp::CvigenerecipherApp()
{
...
// Единственный объект CvigenerecipherApp

CvigenerecipherApp theApp;


// Инициализация CvigenerecipherApp

BOOL CvigenerecipherApp::InitInstance()
{
